...
public class InfoPanganActivity2 extends AppCompatActivity {
        ...
        AndroidNetworking.post(GlobalActivtiy.DATA + "data-harga/" + pasar + "/" + tanggal)
                ...
                .getAsObject(ResponseKomoditas.class, new ParsedRequestListener<ResponseKomoditas>() {
                    ...
                    public void onError(ANError anError) {
                        hideProgress();
                        Toasty.error(InfoPanganActivity2.this, "Failed!", Toasty.LENGTH_LONG).show();
    ...
    public void onViewClicked() {
        startActivity(new Intent(InfoPanganActivity2.this, LoginActivity.class));
    }
